 ...
 * wxRequest具体调用函数
 */
// import InterceptorManager form "./InterceptorManager";  有误
...
class WxRequest {
    ...
    __initInterceptor() {
        ...
        this.interceptors.use({
            ...
            requestError(requestError) {
                return Promise.reject(requestError); //Promise拒绝了下一步,并将requestError传递出去
            },
            response(response) {
    ...
    __initDefaults() {
        ...
        //合并参数对象
        this.default = Object.assign({}, defaults, this.defaults)
    }
